...
class Batch(object):
    ...
    def construct_encoder_input(self, code_vocab, action_vocab, nl_vocab, node_vocab, type_vocab, device):
        code_tensor_a, code_tensor_b, action_tensor = self.get_code_change_tensors(code_vocab, action_vocab, device)
        node_value_tensor, node_type_tensor, node_action_tensor = self.get_node_tensors(node_vocab, action_vocab,
                                                                                        type_vocab, device)
