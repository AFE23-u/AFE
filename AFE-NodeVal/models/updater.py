...
class BaseUpdater(base.BaseModel, ABC):
    ...
    def __init__(self, vocab: Union[Vocab, MixVocab],
        ...
        self.code_vocab, self.nl_vocab, self.node_vocab, self.node_type_vocab, self.action_vocab = self.vocab.get_subvocabs()
    ...
    def forward(self, batch: Batch) -> Tensor:
        input_tensor = batch.construct_encoder_input(self.code_vocab, self.action_vocab, self.nl_vocab, self.node_vocab,
